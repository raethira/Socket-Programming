...
cout<<"The ServerB recieved input "<<"<"<<word<<">"<<" and operation "<<"<"<<func<<">"<<endl;
...
infile.open("/home/ee450/Downloads/backendB.txt");
...
count2 = 1;
cout<<"The ServerB has found "<<"<"<<count2<<">"<<" match and "<<"<"<<count<<">"<<" similar words"<<endl;
...
str = ss.str();
res2 = res+"@"+str;
cout<<"The ServerB has found" <<"<"<<n<<">"<<" matches"<<endl;
}
...
//sending thee result to Aws
sendto(sockfd,result,2048,0,(struct sockaddr*)&si_other,addr_size);
cout<<"The ServerB fininshed sending the output to AWS"<<endl;
